...
export class Backend implements backendInterface {
    ...
    async getAllForms(): Promise<Array<ContactForm>> {
    ...
    async getFormsByInterest(arg0: string): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFormsByInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
